        ...
        <div className="main">
            ...
            <div className="common">
                <div className="first">
                    ...
                    <input type="text" className="name" name="givenName" value={values.givenName} onChange={onChangeHandler}/>
                </div>
                <div class="last">
                    <label className='label' htmlFor="familyName">Last Name</label>
                    <input type="text" className="name" name="familyName" value={values.familyName} onChange={onChangeHandler} />
                </div>
            </div>

            <label className='label' htmlFor="nationality">Nationality</label>
            <input type="text" className="details" name="nationality" value={values.nationality} onChange={onChangeHandler}/>

            <label className='label' htmlFor="password">Permanent Number</label>
            <input type="number" className="details" name="permanentNumber" value={values.permanentNumber} onChange={onChangeHandler}/>
            ...
            <input type="text" className="details" name="code" value={values.code} onChange={onChangeHandler}/>
